require("octo").setup({
  ...
  mappings = {
    ...
    review_thread = {
      -- goto_issue = { lhs = "<leader>gi", desc = "navigate to a local repo issue" },
      add_comment = { lhs = "ca", desc = "add comment" },
      add_suggestion = { lhs = "cs", desc = "add suggestion" },
      delete_comment = { lhs = "cd", desc = "delete comment" },
      next_comment = { lhs = "cn", desc = "go to next comment" },
      prev_comment = { lhs = "cp", desc = "go to previous comment" },
      select_next_entry = { lhs = "c-n", desc = "move to previous changed file" },
      select_prev_entry = { lhs = "c-p", desc = "move to next changed file" },
      select_first_entpy = { lhs = "cf", desc = "move to first changed file" },
      select_last_entry = { lhs = "cl", desc = "move to last changed file" },
    ...
    review_diff = {
      ...
      add_review_suggestion = { lhs = "cs", desc = "add a new review suggestion" },
      focus_files = { lhs = "<leader>e", desc = "move focus to changed file panel" },
      toggle_files = { lhs = "<leader>b", desc = "hide/show changed files panel" },
      next_thread = { lhs = "tn", desc = "move to next thread" },
      prev_thread = { lhs = "tp", desc = "move to previous thread" },
      select_next_entry = { lhs = "c-n", desc = "move to previous changed file" },
      select_prev_entry = { lhs = "c-q", desc = "move to next changed file" },
      select_first_entry = { lhs = "cf", desc = "move to first changed file" },
      select_last_entry = { lhs = "cl", desc = "move to last changed file" },
      close_review_tab = { lhs = "<c-q>", desc = "close review tab" },
    ...
    file_panel = {
      ...
      select_first_entry = { lhs = "cf", desc = "move to first changed file" },
      select_last_entry = { lhs = "cl", desc = "move to last changed file" },
      close_review_tab = { lhs = "<c-q>","c-q", desc = "close review tab" },
      -- toggle_viewed = { lhs = "<leader><leader>", desc = "toggle viewer viewed state" },
    },
  },
})
